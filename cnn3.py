...
for f in filedata:
  ...
  n = n + 1
#label2 = np.ones(len(img_set) - len1) * (-1)
label3 = np.ones(len(img_set) - len1 - len2) * 2

img_label_temp = np.append(label1,label2)
img_label = np.append(img_label_temp,label3)
print(img_label)
print(len(img_label))
print(len(img_set))
...
print(img_label)
#print(img_label[10],img_label[1000],img_label[2000])
...
# Train the model.
history = model.fit(train_images,train_labels,batch_size=bt_size,validation_split=0.20, epochs=20)

# Save the model to disk.
model.save_weights('cnn_3class.h5')
...
val_f1 = f1_score(actual, pred, average = None, labels=[0])
#print(pred)
#print(actual)
#val_f1 = f1_score(actual, pred, average = None, labels=[0])
...
df.to_csv('predicted_values_cnn_3class.txt', index=False)
...
plt.title('Accuracy vs validation 3 class')
plt.ylabel('Accuracy')
plt.xlabel('Epoch')
...
figpath = "./CNN_output/"
name = figpath + "acc_graph_3class"  + '.png'
plt.savefig(name)
acc_vect = []
#plt.show()

model.compile(optimizer=optimizr,loss=lossf,metrics=['accuracy'],)
history1 = model.fit(train_images,train_labels,batch_size=1,validation_split=0.20, epochs=6,verbose=0,shuffle = False)
[test_loss, test_acc] = model.evaluate(test_images,test_labels,verbose=0)
acc_vect.append(test_acc)
print("Accuracy for batch size 1 = ",test_acc)
predictions = model.predict(test_images)
pred = np.argmax(predictions, axis=1)
val_f1_1 = f1_score(actual, pred, average = None, labels=[0])

model.compile(optimizer=optimizr,loss=lossf,metrics=['accuracy'],)
history1 = model.fit(train_images,train_labels,batch_size=4,validation_split=0.20, epochs=6,verbose=0,shuffle = False)
[test_loss, test_acc] = model.evaluate(test_images,test_labels,verbose=0)
acc_vect.append(test_acc)
print("Accuracy for batch size 4 = ",test_acc)
predictions = model.predict(test_images)
pred = np.argmax(predictions, axis=1)
val_f1_4 = f1_score(actual, pred, average = None, labels=[0])

model.compile(optimizer=optimizr,loss=lossf,metrics=['accuracy'],)
history2 = model.fit(train_images,train_labels,batch_size=16,validation_split=0.20, epochs=6,verbose=0,shuffle = False)
[test_loss, test_acc] = model.evaluate(test_images,test_labels,verbose=0)
acc_vect.append(test_acc)
print("Accuracy for batch size 16 = ",test_acc)
predictions = model.predict(test_images)
pred = np.argmax(predictions, axis=1)
val_f1_16 = f1_score(actual, pred, average = None, labels=[0])

model.compile(optimizer=optimizr,loss=lossf,metrics=['accuracy'],)
history3 = model.fit(train_images,train_labels,batch_size=32,validation_split=0.20, epochs=6,verbose=0,shuffle = False)
[test_loss, test_acc] = model.evaluate(test_images,test_labels,verbose=0)
acc_vect.append(test_acc)
print("Accuracy for batch size 32 = ",test_acc)
predictions = model.predict(test_images)
pred = np.argmax(predictions, axis=1)
val_f1_32 = f1_score(actual, pred, average = None, labels=[0])

model.compile(optimizer=optimizr,loss=lossf,metrics=['accuracy'],)
history3 = model.fit(train_images,train_labels,batch_size=64,validation_split=0.20, epochs=6,verbose=0,shuffle = False)
[test_loss, test_acc] = model.evaluate(test_images,test_labels,verbose=0)
acc_vect.append(test_acc)
print("Accuracy for batch size 64 = ",test_acc)
predictions = model.predict(test_images)
pred = np.argmax(predictions, axis=1)
val_f1_64 = f1_score(actual, pred, average = None, labels=[0])

model.compile(optimizer=optimizr,loss=lossf,metrics=['accuracy'],)
history4 = model.fit(train_images,train_labels,batch_size=256,validation_split=0.20, epochs=6,verbose=0,shuffle = False)
[test_loss, test_acc] = model.evaluate(test_images,test_labels,verbose=0)
print("Accuracy for batch size 256 = ",test_acc)
acc_vect.append(test_acc)
predictions = model.predict(test_images)
pred = np.argmax(predictions, axis=1)
val_f1_256 = f1_score(actual, pred, average = None, labels=[0])

model.compile(optimizer=optimizr,loss=lossf,metrics=['accuracy'],)
history4 = model.fit(train_images,train_labels,batch_size=512,validation_split=0.20, epochs=6,verbose=0,shuffle = False)
[test_loss, test_acc] = model.evaluate(test_images,test_labels,verbose=0)
print("Accuracy for batch size 512 = ",test_acc)
acc_vect.append(test_acc)
predictions = model.predict(test_images)
pred = np.argmax(predictions, axis=1)
val_f1_512 = f1_score(actual, pred, average = None, labels=[0])

len2 = len(train_images)
model.compile(optimizer=optimizr,loss=lossf,metrics=['accuracy'],)
history4 = model.fit(train_images,train_labels,batch_size=len2,validation_split=0.20, epochs=6,verbose=0,shuffle = False)
[test_loss, test_acc] = model.evaluate(test_images,test_labels,verbose=0)
print("Accuracy for batch size all (",len2, ") =",test_acc)
acc_vect.append(test_acc)
predictions = model.predict(test_images)
pred = np.argmax(predictions, axis=1)
val_f1_len = f1_score(actual, pred, average = None, labels=[0])
...
plt.figure()
plt.title('Accuracy vs BatchSize for 3 class')
plt.ylabel('Accuracy')
...
if not os.path.exists(final_directory):
  os.makedirs(final_directory)
figpath = "./CNN_output/"
name = figpath + "acc_batchSize_3class"  + '.png'
plt.savefig(name)
